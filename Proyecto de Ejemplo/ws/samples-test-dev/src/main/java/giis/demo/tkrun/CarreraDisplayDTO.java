 ...
 * Capitalizar todas las palabras que forman un identificador excepto la primera
 * letra de nombres de métodos y variables. - No utilizar subrayados Seguir
 * tambien estos mismos criterios en los nombres de tablas y campos de la BD
 */
