...
/**
 * Metodos de utilidad para interfaces de usuario con swing (poblar tablas a
 * partir de un objeto POJO que ha sido obtenido desde la base de datos, manejo
 * de excepciones para metodos del controlador, autoajuste de la dimension de
 * columnas, etc)
 */
public class SwingUtil {
	...
	/**
	 * Ejecuta un metodo en respuesta a un evento envolviendolo en un manejador de
	 * excepciones estandar que muestra un mensaje informativo o mensaje de error en
	 * funcion de la excepcion producida (utilizado en el Controlador al instalar
	 * los handlers en respuesta a los eventos de swing) NOTA: Si devolviese
	 * parametros utilizar Consumer en vez de Runnable:
	 * http://www.baeldung.com/java-lambda-exceptions
	 * 
	 * @param consumer Metodo a ejecutar (sin parametros de entrada ni valores de
	 *                 salida)
	 */
	...
	/**
	 * Ajusta todas las columnas de la tabla al tamanyo correspondiente al contenido
	 * del tablemodel
	 */
	...
	/**
	 * Obtiene la key (primera columna) de la fila seleccionada en la tabla de
	 * carreras o string vacio (si no existe)
	 */
	...
	/**
	 * Selecciona la fila de la tabla con la clave indicada y devuelve el valor la
	 * clave de la fila seleccionada resultante (la misma clave o string vacio si no
	 * existe la fila)
	 */
	...
	/**
	 * Crea un tablemodel a partir de una lista de objetos POJO con las columnas que
	 * se indican.
	 * 
	 * @param pojos         Lista de objetos cuyos atributos se utilizaran para
	 *                      crear el tablemodel (utiliza apache commons beanutils).
	 *                      Si es null solamente crea el tablemodel con las
	 *                      cabeceras de columna
	 * @param colProperties Los nombres de atributo de los objetos (ordenados) que
	 *                      se incluiran en el tablemodel (cada uno debe disponer
	 *                      del correspondiente getter)
	 */
	...
	public static <E> TableModel getRecordModelFromPojo(E pojo, String[] colProperties) {
		// Creacion inicial del tablemodel y dimensionamiento
		// como solo habra dos columnas pongo una cabecera con dos valores vacios, de
		// forma que
		// aparezca muy reducida pero con el handler necesario para poder
		// redimensionarla
		TableModel tm;
	 ...
	 * 
	 * @param lst Lista de arrays de objetos de los cuales se usara el primero de
	 *            cada uno de ellos para poblar el combo
	 */
