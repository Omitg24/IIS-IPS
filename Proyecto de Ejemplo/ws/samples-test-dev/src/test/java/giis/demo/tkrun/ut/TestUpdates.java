...
/**
 * Ejemplo de comprobación de resultados en pruebas que actualizan la base de
 * datos. Se tratan igual que las que consultan, pero en este caso es esencial
 * comprobar tanto los datos que se actualizan en la base de datos los datos que
 * tienen que cambiar como que no se han actualizado los datos que no deberian
 * cambiar
 */
public class TestUpdates {
	...
	/**
	 * Prueba otro metodo del modelo que actualiza las fechas de inscripcion de una
	 * carrera: comprueba tanto las fechas que se han actualizado como las que no se
	 * han actualizado para evitar efectos indeseados
	 */
	@Test
	public void testUpdateFechasInscripcion1() {
		...
		// lee todos los datos de la tabla y las compara con los iniciales tras cambiar
		// solamente estos dos datos
	...
	/**
	 * Lo anterior comprueba todos los datos pero es dificil de establecer los
	 * valores deseados pues hay que reproducir todo el contenido de la tabla
	 * inicial salvo lo que debe cambiar. Otra forma mas facil crear primero la
	 * salida deseada leyendo de la base de datos y modificando solo los valores que
	 * cambian
	 */
	@Test
	public void testUpdateFechasInscripcion2() {
		// crea la salida deseada leyendo el estado inicial y cambiando solo las fechas
		// de la carrera 101 (segundo elemento de la lista)
		...
		// El assert se hace sobre las representaciones csv de los datos para que en
		// caso de discrepancias sea facil de comprobar
