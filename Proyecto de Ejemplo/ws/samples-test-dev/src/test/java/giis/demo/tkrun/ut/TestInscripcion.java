...
public class TestInscripcion {
	...
	public static void loadCleanDatabase(Database db) {
		db.executeBatch(new String[] { "delete from carreras",
	...
	/**
	 * Comprueba la lista de carreras que ve el usuario en el momento de la
	 * inscripcion para diferentes fases de inscripcion: Debe mostrar todas las
	 * carreras excluyendo las pasadas, indicando Abierto en las que se puede
	 * realizar inscripcion; Con la base de datos del setUp cubre las cinco clases
	 * de equivalencia relativas a Fecha de inscrpcion (carreras 100 a 104)
	 */
	@Test
	public void testCarrerasActivasList() {
		...
		// Deben mostrarse todas las carreras de la BD menos la primera que es pasada,
		// la ultima no debe indicar abierto
	...
	/**
	 * Alternativa para comparacion de los valores de una lista, pasando todos sus
	 * elementos a un string, es mas compacto y facil la comparacion de resultados
	 */
	@Test
	...
	/**
	 * Convierte una lista de Object[] a un string, separando cada item por salto de
	 * linea
	 */
	...
	/**
	 * Otra version de una variante del metodo getListaCarreras, en este caso el DAO
	 * devuele una lista de objetos con tres valores, las comparaciones se realizan
	...
	/**
	 * Alternativa para comparacion utilizando una representacion serializada del
	 * DTO a Json (utiliza un metodo de utilidad basado en Jackson): Es mas compacto
	 * y facilita la comparacion de resultados, permitiendo tambien realizar las
	 * comparaciones cuando se prueba un api REST
	 */
	@Test
	...
	/**
	 * Otra alternativa que facilita la comparacion, en vez de comparar con el Json
	 * completo se compara con una representacion estilo CSV en el que cada atributo
	 * del objeto se representa como un elemento de un array
	 */
	@Test
	...
	/**
	 * Igual que el anterior, pero utiliza otro componente (visual-assert) para
	 * comparar y generar un archivo html con las diferencias, que se puede revisar
	 * sin depender del entorno Eclipse (util si los strings que se comparan son de
	 * gran tamanyo)
	 */
	@Test
	public void testCarrerasActivasDaoCsvHtmlDiffs() {
		CarrerasModel inscr = new CarrerasModel();
		List<CarreraDisplayDTO> carreras = inscr.getListaCarreras(Util.isoStringToDate("2016-11-10"));
		VisualAssert va = new VisualAssert(); // si no se personaliza la configuracion dejara los ficheros con
												// diferencias en target
		va.assertEquals(
				"101,en fase 3,(Abierta)\n" + "102,en fase 2,(Abierta)\n" + "103,en fase 1,(Abierta)\n"
						+ "104,antes inscripcion,\n",
				Util.pojosToCsv(carreras, new String[] { "id", "descr", "estado" }));
	...
	/**
	 * No se han determinado en el disenyo clases invalidas, pero para completar la
	 * prueba se comprobara la validez de los parametros recibidos. En
	 * getListaCarreras solo hay una fecha, que podria ser nula si es invocado
	 * incorrectmente. Esto sirve como ejemplo de como comprobar con JUnit3 cuando
	 * el comportamiento deseado es una excepcion.
	 */
	...
	/**
	 * Determinacion del descuento o recargo porcentual segun la fecha de
	 * inscripcion (Cubre las clases validas para el Porcentaje de descuento: 3
	 * relativas fecha de inscripcion y 1 relativa al id de carrera valido )
	 */
	@Test
	public void testPorcentajeDescuentoRecargoValidas() {
		// Reutilizamos el setUp para los tests de la lista de carreras mostradas al
		// usuario
	...
	/**
	 * Determinacion del descuento o recargo porcentual segun la fecha de
	 * inscripcion (Cubre las clases invalidas, a las que habria que anyadir la
	 * validacion de la fecha) Se podria realizar en tres metodos similares a los
	 * anteriores o en uno solo con tres partes similares. Para evitar duplicacion
	 * de codigo se utiliza un metodo generico invocado desde los tres tests
