...
/**
 * Ejemplo de pruebas con JUnit3 (incluye las pruebas de getListaCarreras y las
 * invalidas de getDescuentoRecargo) Pruebas del ejemplo de Inscripciones en
 * carreras populares (primer ejemplo). Notar que en JUnit3 no se usan
 * anotaciones, sino convenios (Test* para la clases, test* para los metodos,
 * setUp y tearDown para inicializacion y finalizacion), las clases deben
 * extender TestCase, que ya define los metodos estaticos assert*
 */
